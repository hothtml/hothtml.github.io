...
function kl_auto_backup_and_mail_trigger()
{
	...
	if(Dispatcher::setPath() != '/t/') echo "<script type=\"text/javascript\">XMLHttp.sendReq('GET','".DYNAMIC_BLOGURL."/content/plugins/kl_auto_backup_and_mail/kl_auto_backup_and_mail_do.php','',function(obj){return;});</script>\r\n";
}
